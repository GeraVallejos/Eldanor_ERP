...
class CuentaBancariaEmpresa(TenantRelationValidationMixin, BaseModel):
    ...
    class Meta:
        db_table = "tesoreria_cuentabancariaempresa"
        constraints = [
        ...
        indexes = [
            models.Index(fields=["empresa", "activa"], name="tes_ctabco_emp_act_idx"),
            models.Index(fields=["empresa", "banco"], name="tes_ctabco_emp_banco_idx"),
        ]
...
class MovimientoBancario(TenantRelationValidationMixin, BaseModel):
    ...
    cuenta_bancaria = models.ForeignKey(
        "tesoreria.CuentaBancariaEmpresa",
    ...
    class Meta:
        db_table = "tesoreria_movimientobancario"
        indexes = [
            models.Index(fields=["empresa", "fecha"], name="tes_movbco_emp_fec_idx"),
            models.Index(fields=["empresa", "conciliado"], name="tes_movbco_emp_conc_idx"),
            models.Index(fields=["empresa", "cuenta_bancaria", "fecha"], name="tes_movbco_emp_cta_fec_idx"),
        ]
