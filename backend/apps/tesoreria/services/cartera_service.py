...
from apps.tesoreria.models import CuentaPorCobrar, CuentaPorPagar, EstadoCuenta, Moneda
...
class CarteraService:
    ...
    def registrar_cxp_desde_documento_compra(*, documento, usuario=None):
        ...
        # Incluye sufijo estable por documento para evitar colision al reingresar mismo folio tras anulacion.
