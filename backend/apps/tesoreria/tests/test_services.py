...
from apps.tesoreria.models import CuentaPorCobrar, Moneda
from apps.tesoreria.services import CarteraService, TipoCambioService


@pytest.mark.django_db
class TestTesoreriaServices:
